...
import { DeleteExpense, DeleteSales, GetOffersList, UpdateProjectExpense, UpdateProjectSales, UpdateStatusOnOfferAcceptance } from '@services/fd-service/project_service';
...
const SalesTable = ({projectSales, setProjectSales, rerender, setRerender}) => {
  let sellingStep = 0;
                ...
                <TableBody>
                    ...
                    <TableRow>
                        ...
                        <TableCell key={'totalAmount'} align='center' style={{fontWeight: '700', fontSize: '16px'}}> {
                            `${calculateTotal(projectSales).toLocaleString('us')} Taka`
                        } </TableCell>
                    </TableRow>
                </TableBody>
                </Table>
