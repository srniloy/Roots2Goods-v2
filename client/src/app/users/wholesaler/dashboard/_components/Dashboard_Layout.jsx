...
const DashboardLayout = ({ children }) => {
  ...
  const frmrTabClickAction = (e) => {
    ...
    if (e.target.innerHTML == "Business Analytics") {
      ...
      router.push('/users/wholesaler/dashboard/products')
    }
    else if (e.target.innerHTML == "Transaction") {
      router.push('/users/wholesaler/dashboard/transactions')
    }
    else if(e.target.innerHTML == "Stocked Products"){
      router.push('/users/wholesaler/dashboard/stocks')
    }
    else if(e.target.innerHTML == "Offers Update"){
      router.push('/users/wholesaler/dashboard/offers-update')
    }
